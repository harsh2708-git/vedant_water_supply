...
import com.production.vedantwatersupply.utils.infiniteviewpager.InfinitePagerAdapter;
import com.production.vedantwatersupply.utils.infiniteviewpager.InfiniteViewPager;
...
public class CaldroidFragment extends DialogFragment {
     ...
     */
    public static int selectedBackgroundDrawable = R.color.black;
    public static int selectedTextColor = Color.WHITE;
    /**
     * To customize the disabled background drawable and text color
     */
    public static int disabledBackgroundDrawable = R.color.white;
    public static int disabledTextColor = R.color.bg_light_gry;
    ...
    public Integer getBackgroundResourceForDate(Date date) {
        DateTime dateTime = CalendarHelper.convertDateToDateTime(date);
    ...
    public void prevYear() {
        moveToDateTime(pageChangeListener.getCurrentDateTime().minus(1, 0, 0, 0, 0, 0, 0, DateTime.DayOverflow.LastDay));
    }
    ...
    public void nextYear() {
        moveToDateTime(pageChangeListener.getCurrentDateTime().plus(1, 0, 0, 0, 0, 0, 0, DateTime.DayOverflow.LastDay));
    }
    ...
    public void refreshView() {
        ...
        // Refresh title view
        monthTitleTextView.setText(String.format("%s %d", new DateTime(year, month, 1, 0, 0, 0, 0)
                .format("MMMM", Locale.getDefault()), year));
        if (isHoneyCombOrLater()) {
            ObjectAnimator pulseAnimator = Utils.getPulseAnimator(
                    monthTitleTextView, 0.9f, 1.05f);
    ...
    /**
     * Retrieve initial arguments to the fragment GetRetailStationProductPrice can include: month, year,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        timePicker = view.findViewById(R.id.tpTime);
        ...
        view.findViewById(R.id.calendar_prev_year).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                prevYear();
            }
        ...
        view.findViewById(R.id.calendar_next_year).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                nextYear();
            }
        ...
        WeekdayArrayAdapter weekdaysAdapter = new WeekdayArrayAdapter(
                getActivity(), R.layout.calender_view_item,
                getDaysOfWeek());
            ...
            public void onClick(View v) {
                if (caldroidListener != null) {
                    ...
                    if (!selectedDates.isEmpty()) {
                        ...
                        date = CalendarHelper.convertDateTimeToDate(dateTime);
                        if (date != null) {
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    ...
                    caldroidListener.onOkClicked(date);
                    dismiss();
                }
            }
        });
    ...
    private ArrayList<String> getDaysOfWeek() {
        List<String> list;
        list = new ArrayList<>(Arrays.asList("S", "M", "T", "W", "T", "F", "S"));
