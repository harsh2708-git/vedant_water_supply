...
public class CaldroidGridAdapter extends BaseAdapter {
    ...
    protected void customizeTextView(int position, TextView cellView) {
        ...
        if ((minDateTime != null && dateTime.lt(minDateTime))
            ...
            cellView.setTextColor(context.getResources().getColor(CaldroidFragment.disabledTextColor));
            if (CaldroidFragment.disabledBackgroundDrawable == -1) {
                cellView.setBackgroundColor(context.getResources().getColor(R.color.white));
            } else {
                cellView.setBackgroundResource(CaldroidFragment.disabledBackgroundDrawable);
            }

            if (dateTime.equals(getToday())) {
                cellView.setBackgroundResource(R.drawable.green_circle);
            }
        } else {
            cellView.setBackgroundResource(R.color.available_date_bg);
        ...
        cellView.setText(String.format("%d", dateTime.getDay()));
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // For reuse
        if (convertView == null) {
            cellView = (TextView) inflater.inflate(R.layout.date_cell, parent, false);
        }
